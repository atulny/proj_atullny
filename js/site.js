...
function carousal(config){
	...
	function resume(){
		if(wrapinner.scrollWidth<wrap.offsetWidth){
			//it content width is less than container - nothing to do - return
			return
		}
	...
	wrap.addEventListener("mouseout",resume);
	 ...
	 var api={init:_init,start:resume, pause:pause, resume:resume}
	//return api
}
